...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('content_content', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['auth.User']),
                      keep_default=False)


        # Changing field 'Content.slug'
        db.alter_column('content_content', 'slug', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):
        # Deleting field 'Content.user'
        db.delete_column('content_content', 'user_id')


        # Changing field 'Content.slug'
        db.alter_column('content_content', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))
